...
public class RegisterStepOneActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        findViewById(R.id.register_tv_next).setOnClickListener(this);
    }

    @Override
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.register_tv_next:
                if (mPageType == ActivityConstants.PARAM_VALUE_FIND_PASSWORD) {
                    Intent i = new Intent(RegisterStepOneActivity.this, RegisterStepTowActivity.class);
                    i.putExtra(ActivityConstants.PARAM_KEY_REGISTER_OR_FIND,ActivityConstants.PARAM_VALUE_FIND_PASSWORD);
                    startActivity(i);
                } else {
                    UIHelper.gotoActivity(RegisterStepOneActivity.this, RegisterStepTowActivity.class);
                }
                break;
            case R.id.title_back:
                goBack(RegisterStepOneActivity.this);
                break;
        }
    }
}
